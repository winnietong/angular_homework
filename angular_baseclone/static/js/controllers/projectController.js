function projectController($scope, $http, $routeParams, $resource, $location, ProjectFactory) {
    // Here we'll use $routeParams to get the id from the URL and then append it
    // to our $http.get URL
    var projectId = $routeParams.id;

    // Delete a specific Project using Project Factory
    // ng-click = deleteProject(project.id) to instantiate
